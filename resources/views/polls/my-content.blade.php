                        ...
                        <div class="p-8 flex-grow">
                            <div class="flex justify-between items-start mb-5">
                                <div class="flex gap-2">
                                    ...
                                    @if(!$poll->is_active)
                                        <span class="px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-100 dark:border-amber-500/20">

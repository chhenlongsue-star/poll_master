<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600">
        {{ __('Log in to your account to start voting or managing polls.') }}
    </div>
    ...
    <div class="relative flex items-center justify-center mt-6">
        ...
        <div class="relative px-3 text-sm text-gray-500 bg-white">
            Or continue with
        </div>
    </div>
    ...
    <div class="mt-6">
        <a href="{{ route('auth.google') }}" class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            <img class="w-5 h-5 mr-2" src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google logo">
